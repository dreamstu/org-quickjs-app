package org.quickjs.app.utils.view;
 ...
 *
 */
public class AppViewResolver implements ViewResolver {

	private static Log logger = LogFactory.getLog(AppViewResolver.class);
